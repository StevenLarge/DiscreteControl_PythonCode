...
def Driver_PreRead(NumCPVals,TotalTime,CPVals,LagTime,CorrelationMesh): 			
	...
	OptimalResult = scipy.optimize.minimize(CostFunctionInfinite, CPDiff_Tuple, args=Parameter_Tuple, method="SLSQP", bounds=Bnds, constraints=Cons, options={'ftol':1e-09})
