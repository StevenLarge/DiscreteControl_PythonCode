...
def Driver_PreRead_Brute(Iterations,NumCPVals,TotalTime,CPVals,LagTime,CorrelationMesh): 			
	...
	for index in range(Iterations):
		...
		#if index!=0:
		OptimalResult = scipy.optimize.minimize(SpatialCostFunctionInfinite, CPDiff_Tuple, args=SpaceParameter_Tuple, method="SLSQP", bounds=Bnds_Space, constraints=Cons_Space, options={'ftol':1e-09})
